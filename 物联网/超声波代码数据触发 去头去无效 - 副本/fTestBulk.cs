...
namespace Test_Bulk
{
    ...
    public partial class fTestBulk : Form
    {
        ...
        static int[] ReadBuffer1 = new int[1920];  //缓冲区 1
                ...
                if (judgeValidBag(e.Buffer, j))
                {
                    for (i = 0; i < 60; i++)
                    {
                        ...
                        if (flag)  //buffer1工作
                        {
                            ...
                            if (count1 == 32768) //如果第一个buffer1满了，则换buffer2工作，并置count1=0
                            {
                                flag = false;
                                count1 = 0;
                                Thread t2 = new Thread(saveData); //存到文件中
                                t2.Start();
                            }
                        }
                        else  //buffer2工作
                        {
                            ...
                            if (count2 == 32768) //如果第一个buffer2满了，则换buffer1工作，并置count2=0
                            {
                                flag = true;
                                count2 = 0;
